...
現在のMVPは愛知県、静岡県、岐阜県、三重県に加えて、東京都、大阪府、京都府、神奈川県、埼玉県、千葉県、北海道、宮城県、新潟県、岡山県、兵庫県、広島県、福岡県、熊本県、鹿児島県の主要都市に対応し、ネットカフェ、ゲームセンター、アダルトショップ、カラオケ、サウナ、スーパー銭湯・SPA・岩盤浴、猫カフェ、飲食店・居酒屋、ダーツ、ボウリング場、ビリヤード、映画館、ビデオボックス、カプセルトイ、クレーンゲーム・UFOキャッチャー、コンビニ、カフェを扱います。
